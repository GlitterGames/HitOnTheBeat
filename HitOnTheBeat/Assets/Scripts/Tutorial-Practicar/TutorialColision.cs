...
public class TutorialColision
{
    ...
    public void EndPowers()
    {
        ...
        {
            int pos = positions[i];
            if (g.jugadores[pos].Power == TutorialPlayerController.Power_Up.ESCUDO)
            {
    ...
    public bool PerformSingleColision(TutorialPlayerController p, FloorDetectorType dir, int fuerza, int golpeador, bool moreThanTwo, bool notCinematic, bool sameFloor)
    {
